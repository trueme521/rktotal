...
//       with a string literal via the family of _RS... macros (see
		...
		public __bs_ns__::basic_string<_E, _Tr, _A>
{
	...
	void  _initW ( const wchar_t* pwszSrc, int nLen )
	{
		...
		bRetCode = IsTextUnicode((void*)pwszSrc, nLen, NULL);
		if (bRetCode == TRUE)
		{
...
public:
	...
	#if !defined(USE_CURRENT_STL_IMPL)
	BasicString ( const __bs_internal__::FastRawStringInitializer<_E>& _RS )
	{
		//     In case of using base class initialization expression
		// _Myt(reinterpret_cast<const _Myt&>(_RS)) performance decreases
		// as much as 4 times! (Incredibly, but it is the fact.)
		*(DWORD*)(this) = (DWORD)_RS._Ptr;
	}
...
inline
	BasicString<_E, _Tr, _A>  operator + ( 
							...
							const BasicString<_E2, _Tr2, _A2>& _RS )
{
	return  BasicString<_E, _Tr, _A>(_L) += _RS;
}
template<class _E, class _E2, class _Tr, class _Tr2, class _A, class _A2> 
inline 
	BasicString<_E, _Tr, _A>  operator + ( 
...
inline
    BasicString<_E, _Tr, _A>  operator + ( 
							const BasicString<_E, _Tr, _A>& _L, 
							const std::basic_string<_E2, _Tr2, _A2>& _RS )
{
	return  BasicString<_E, _Tr, _A>(_L) += BasicString<_E, _Tr, _A>(_RS);
}
...
inline
    bool  operator == ( const std::basic_string<_E, _Tr, _A>& _L, 
						const BasicString<_E2, _Tr2, _A2>& _RS )
{
	return  BasicString<_E, _Tr, _A>(_L).compare(_RS) == 0;
}
template<class _E, class _E2, class _Tr, class _Tr2, class _A, class _A2> 
inline
    bool  operator == ( const BasicString<_E, _Tr, _A>& _L, 
						const std::basic_string<_E2, _Tr2, _A2>& _RS )
{
	return  _L.compare(BasicString<_E2, _Tr2, _A2>(_RS)) == 0;
}
...
template<class _E, class _Tr, class _A> inline
    CStringA __cdecl operator += ( CStringA& _L, const BasicString<_E, _Tr, _A>& _RS )
{
	return  _L += (LPCSTR)_RS;
}
template<class _E, class _Tr, class _A> inline
    CStringW __cdecl operator += ( CStringW& _L, const BasicString<_E, _Tr, _A>& _RS )
{
	return  _L += (LPCWSTR)_RS;
}
#elif defined(__CSTRING_SUPPORT__)
template<class _E, class _Tr, class _A> inline
    CString __cdecl operator += ( CString& _L, const BasicString<_E, _Tr, _A>& _RS )
{
	return  _L += (LPCTSTR)_RS;
}
#endif
...
template<class _E, class _E2, class _Tr, class _A> inline
    BasicString<_E, _Tr, _A> __cdecl operator + ( const BasicString<_E, _Tr, _A>& _L, const _E2* _RS )
{
	return  BasicString<_E, _Tr, _A>(_L) += _RS;
}
template<class _E, class _E2, class _Tr, class _A> inline
    BasicString<_E, _Tr, _A>  operator + ( const _E2* _L, 
								const BasicString<_E, _Tr, _A>& _RS )
{
	return  BasicString<_E, _Tr, _A>(_L) += _RS;
}
...
template<class _E, class _Tr, class _A> inline
    BasicString<_E, _Tr, _A>  operator + ( 
								...
								const _bstr_t& _RS )
{
	return  BasicString<_E, _Tr, _A>(_L) += (const _E*)_RS;
}
#endif
...
template<class _E, class _Tr, class _A> inline
    CStringA  operator + ( const CStringA& _L, 
						  const BasicString<_E, _Tr, _A>& _RS )
{
	return  CStringA(_L) += CStringA((LPCSTR)_RS);
}
...
template<class _E, class _Tr, class _A> inline
    CStringW  operator + ( const BasicString<_E, _Tr, _A>& _L, 
						  const CStringW& _RS )
{
	return  CStringW((LPCWSTR)_L) += _RS;
}
...
template<class _E, class _Tr, class _A> inline
    CStringW  operator + ( const CStringW& _L, 
						  const BasicString<_E, _Tr, _A>& _RS )
{
	return  CStringW(_L) += CStringW((LPCWSTR)_RS);
}
#elif defined(__CSTRING_SUPPORT__)
template<class _E, class _Tr, class _A> inline
...
template<class _E, class _Tr, class _A> inline
    CString  operator + ( const CString& _L, 
						  const BasicString<_E, _Tr, _A>& _RS )
{
	return  CString(_L) += CString((LPCTSTR)_RS);
}
#endif
...
//
template<class _E, class _E2, class _Tr, class _A> inline
bool __cdecl  operator == ( const _E *_L, const BasicString<_E2, _Tr, _A>& _RS)
{
	return  _RS.compare(BasicString<_E2>(_L)) == 0;
}
template<class _E, class _E2, class _Tr, class _A> inline
bool __cdecl  operator == ( const BasicString<_E, _Tr, _A>& _L, const _E2 *_RS)
{
	return  _L.compare((const _E*)BasicString<_E2>(_RS)) == 0;
}

#if defined(__BSTR_T_SUPPORT__)
template<class _E, class _Tr, class _A> inline
bool __cdecl operator == ( const BasicString<_E, _Tr, _A>& _L, const _bstr_t& _RS )
{
	return  _L.compare((const _E*)_RS) == 0;
}

template<class _E, class _Tr, class _A> inline
    bool __cdecl operator == ( const _bstr_t& _L, const BasicString<_E, _Tr, _A>& _RS )
{
	return  _RS == (const _E*)_L;
}
#endif

#if defined(__CSTRING_AW_SUPPORT__)
template<class _E, class _Tr, class _A> inline
    bool __cdecl operator == ( const BasicString<_E, _Tr, _A>& _L, const CStringA& _RS )
{
	return  _L == (LPCSTR)_RS;
}

template<class _E, class _Tr, class _A> inline
    bool __cdecl operator == ( const CStringA& _L, const BasicString<_E, _Tr, _A>& _RS )
{
	return  _RS == (LPCSTR)_L;
}

template<class _E, class _Tr, class _A> inline
    bool __cdecl operator == ( const BasicString<_E, _Tr, _A>& _L, const CStringW& _RS )
{
	return  _L == (LPCWSTR)_RS;
}

template<class _E, class _Tr, class _A> inline
    bool __cdecl operator == ( const CStringW& _L, const BasicString<_E, _Tr, _A>& _RS )
{
	return  _RS == (LPCWSTR)_L;
}
#elif defined(__CSTRING_SUPPORT__)
template<class _E, class _Tr, class _A> inline
    bool __cdecl operator == ( const BasicString<_E, _Tr, _A>& _L, const CString& _RS )
{
	return  _L == (LPCTSTR)_RS;
}

template<class _E, class _Tr, class _A> inline
    bool __cdecl operator == ( const CString& _L, const BasicString<_E, _Tr, _A>& _RS )
{
	return  _RS == (LPCTSTR)_L;
}
#endif
...
//     Macros from the _RS family are intended to be used for optimized
// (maximally quick) initialization of the BasicString objects with
// string literals. _RS is used instead of _T macro, and _RA/_RW macros 
// are used to wrap the ANSI and Unicode string literals correspondingly.
//     Caution! Use _RS, and _RS... macros only to initialize local
// BasicString objects or to pass a raw string to a function accepting 
// BasicString object as its argument.
//     Note that _Str argument of a _RS, _RA, or _RW macro MUST be a 
// string literal (i.e. a quoted string). This is because _RW (and, 
// consequently, sometimes _RS) macro prepends the 'L' letter to its 
